<template>
  <div>
    ...
    <vxe-table
      ...
      <vxe-table-column field="tuihuokuan" title="退货款" sortable></vxe-table-column>
      <vxe-table-column field="youfei" title="退邮费" sortable></vxe-table-column>
      <vxe-table-column field="heji" title="退款合计" sortable></vxe-table-column>
